...
const values = [
  {
    ...
    title: "Simplicity",
    description:
      "We believe in removing complexity to reveal the essential. Every feature serves a purpose, every design choice has intention.",
  },
  {
    icon: Users,
    title: "Accessibility",
    description:
      "Scheduling should be accessible to all. Our tools are designed to work for everyone, regardless of technical expertise.",
  },
  {
    icon: Zap,
    title: "Efficiency",
    description:
      "Time is precious. We create tools that help you accomplish more with less effort, focusing on what truly matters.",
  },
  {
    icon: Heart,
    title: "Mindfulness",
    description:
      "Inspired by minimalism, we design with intention, creating space for clarity and focused thinking.",
  },
];
...
const team = [
  {
    ...
    description:
      "Passionate about creating tools that simplify scheduling and time management through thoughtful design and efficient algorithms.",
  },
];
  ...
  return (
    <div className="wrapper">
      <div className="section-spacing zen-spacing-xl">
        ...
        >
          ...
          <div className="max-w-3xl mx-auto zen-spacing-md">
            <p className="text-xl zen-text-secondary leading-relaxed">
              SmartSched was born from a simple belief: scheduling should be
              intuitive, efficient, and stress-free. Inspired by principles of
          ...
          <div className="zen-surface p-12 zen-shadow-soft">
            ...
            <div className="max-w-4xl mx-auto zen-spacing-md">
              <p className="text-center zen-text-secondary text-lg leading-relaxed">
                ...
                through clean design, powerful algorithms, and an unwavering
        ...
        >
          <div className="zen-surface p-12 zen-shadow-soft">
            <h2 className="text-center mb-12 zen-text-accent">
              Design Philosophy
            </h2>
            <div className="max-w-4xl mx-auto zen-spacing-md">
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center zen-spacing-sm">
                  ...
                  <p className="zen-text-secondary text-sm leading-relaxed">
                    Reduce to the essential. Every element serves a purpose,
                    every interaction has meaning.
                  </p>
                </div>
                <div className="text-center zen-spacing-sm">
                  <h3 className="zen-text-primary font-medium mb-4">
                    Tranquility
                  </h3>
                  <p className="zen-text-secondary text-sm leading-relaxed">
                    Embrace tranquility. Clean interfaces that promote focus and
                ...
                <div className="text-center zen-spacing-sm">
                  ...
                  <p className="zen-text-secondary text-sm leading-relaxed">
                    Aesthetics through function. Elegant solutions that work
